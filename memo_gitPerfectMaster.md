...
### マージには3種類 /Auto Merge：基本的なマージ

状況として、masterブランチとfeatureブランチがあり、それぞれの中で変更がある。featureブランチの変更をmasterブランチに取り込みたい。$ git merge feature を実行。新しい、マージのコミットファイルができる。何が起こっているか。
